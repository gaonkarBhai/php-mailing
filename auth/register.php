                ...
                <div class="col-md-7 col-lg-5 col-xl-5 offset-xl-1">
                    <div>
                        <div class="form-outline mb-4">
                            ...
                            <input type="text" id="name" class="form-control form-control-lg" placeholder="john" name="name" required />
                        </div>
                        <div class="form-outline mb-4">
                            <label class="form-label" for="form1Example23">Phone</label>
                            <input type="phone" id="phone" class="form-control form-control-lg" placeholder="910818xxxx" name="phone" required />
                        </div>
                        <!-- Email input -->
                        <div class="form-outline mb-4">
                        ...
                        <!-- Submit button -->
                        <button type="submit" onclick="registerUser()" class="btn btn-primary btn-lg btn-block">Register</button>
